          ...
          <div className="fade-in-up text-center lg:text-left">
            ...
            <div className="fade-in-up-delay-2 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center mb-8">
              <Button 
                variant="outline"
                size="lg" 
                className="font-semibold px-8 py-3 text-lg backdrop-blur-sm bg-background/10 border-foreground text-foreground hover:bg-primary hover:text-primary-foreground transition-all duration-300 hover:scale-105"
