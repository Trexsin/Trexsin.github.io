      ...
      <div className="container mx-auto px-6">
        ...
        <div className="mb-16">
          ...
          <div className="space-y-6 max-w-4xl mx-auto">
            {education.map((edu, index) => <Card key={index} className="portfolio-card">
                <CardHeader>
        ...
        {/* Achievements */}
        <div className="mb-16">
          <h3 className="text-3xl font-display font-bold text-center mb-12">Notable Activities
        </h3>
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {achievements.map((achievement, index) => <Card key={index} className="portfolio-card text-center p-6">
        ...
        <div>
          ...
          <div className="max-w-4xl mx-auto">
            {volunteering.map((vol, index) => <Card key={index} className="portfolio-card">
                <CardHeader>
                  <div className="flex items-start gap-4">
                ...
                <CardContent>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {vol.activities.map((activity, i) => <Badge key={i} variant="outline" className="skill-badge">
                        {activity}
                      </Badge>)}
                  </div>
